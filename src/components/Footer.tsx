...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-african-brown to-african-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-african-gold">Enkaasani</h3>
            <p className="text-gray-300 mb-4">
              Beautiful African print journals and notebooks that celebrate culture and inspire creativity.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/collections" className="text-gray-300 hover:text-white transition-colors">Collections</Link></li>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-african-gold">Customer Service</h4>
            <ul className="space-y-2">
              ...
              <li><Link href="/care" className="text-gray-300 hover:text-white transition-colors">Care Instructions</Link></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-african-gold">Contact Us</h4>
            <div className="space-y-3">
              <div className="flex items-center">
                <EnvelopeIcon className="h-5 w-5 text-african-gold mr-3" />
                <span className="text-gray-300">hello@enkaasani.com</span>
              </div>
              <div className="flex items-center">
                <PhoneIcon className="h-5 w-5 text-african-gold mr-3" />
                <span className="text-gray-300">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-start">
                <MapPinIcon className="h-5 w-5 text-african-gold mr-3 mt-1" />
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-sm mb-4 md:mb-0">
              © 2024 Enkaasani. All rights reserved.
            </div>
